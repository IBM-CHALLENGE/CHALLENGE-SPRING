...
## Teste da API
Para testar a API de forma mais fácil, disponibilizamos um arquivo *Insomnia_Endpoints.json* com as rotas e outros pré requisitos já configurados, o arquivo pode ser importado no programa **Insomnia**
